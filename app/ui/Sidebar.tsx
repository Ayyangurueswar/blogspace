...
const Sidebar = ({posts}: {
  ...
  return (
    <div className='w-1/3 rounded border border-slate-400 p-4 hidden sm:block h-1/2'>
        <div className='relative mb-8'>
            <input className='w-full p-2 border rounded-md border-slate-700 outline-none' placeholder='Search...' onChange={(e) => {handleSearch(e.target.value)}}/>
            ...
            <div className={`border border-slate-600 rounded p-2 ${hidden ? 'hidden' : ''} absolute z-10 bg-white flex flex-col gap-2 w-full transition duration-300`}>
